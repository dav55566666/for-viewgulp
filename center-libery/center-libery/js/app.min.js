...
if (DOMElements.calendarContainer) {
    flatpickr(DOMElements.calendarContainer, {
        locale: "ru",
        inline: true,
        dateFormat: "d.m.Y",
...
$(DOMElements.bookModalBtn).on('click', function () {
    $(DOMElements.bookModal).addClass('book-modal--active');
});

$(DOMElements.bookModal).find('.close-btn').on('click', function (e) {
    $(DOMElements.bookModal).removeClass('book-modal--active');
});
